                    ...
                    <div className="rounded-3xl border border-zinc-200 bg-white p-4">
                      ...
                      <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
                        <div className="rounded-2xl border border-zinc-100 bg-zinc-50 p-3">
                          ...
                          <p className="mt-1 text-sm font-semibold text-zinc-900">
                            {activeDetail.orders.summary.totalOrders.toLocaleString("id-ID")}
                          </p>
                        </div>
                        <div className="rounded-2xl border border-zinc-100 bg-zinc-50 p-3">
                          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-zinc-400">
                          ...
                          <p className="mt-1 text-sm font-semibold text-zinc-900">
                            {activeDetail.orders.summary.activeOrders.toLocaleString("id-ID")}
                          </p>
                        </div>
                        <div className="rounded-2xl border border-zinc-100 bg-zinc-50 p-3">
                          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-zinc-400">
                          ...
                          <p className="mt-1 text-sm font-semibold text-zinc-900">
                            {activeDetail.orders.summary.deliveredOrders.toLocaleString("id-ID")}
                          </p>
                        </div>
                        <div className="rounded-2xl border border-zinc-100 bg-zinc-50 p-3">
                          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-zinc-400">
                          ...
                          <p className="mt-1 text-sm font-semibold text-zinc-900">
                            {activeDetail.orders.summary.completedOrders.toLocaleString("id-ID")}
                          </p>
                        </div>
                        <div className="rounded-2xl border border-red-100 bg-red-50 p-3">
                          ...
                          <p className="mt-1 text-sm font-semibold text-red-700">
                            {activeDetail.orders.summary.atRiskOrders.toLocaleString("id-ID")}
                          </p>
                        </div>
                      </div>
                      <div className="mt-4 flex flex-col gap-3 rounded-2xl border border-zinc-100 bg-zinc-50 p-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                          <p className="text-sm font-semibold text-zinc-900">
                            Move detailed oversight to the dedicated orders page
                          </p>
                          <p className="mt-1 text-sm text-zinc-500">
                            Search all orders, inspect timelines, and intervene
                            in a cleaner workspace.
                          </p>
                        </div>
                        <Link
                          href={`/orders?userId=${activeDetail.id}`}
